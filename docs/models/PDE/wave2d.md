...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/wave2d/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/wave2d/Dynamics.R)
