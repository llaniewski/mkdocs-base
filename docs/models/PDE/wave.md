...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at f31ccf6)/src/wave/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at f31ccf6)/src/wave/Dynamics.R)
