...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/wave/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/wave/Dynamics.R)
