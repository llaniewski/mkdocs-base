...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/diffusion2D/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/diffusion2D/Dynamics.R)
