...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/advection_diffusion2D_fields/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/advection_diffusion2D_fields/Dynamics.R)
