...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at FETCH_HEAD)/src/d3q27_pf_velocity_thermo_planarBenchmark_autosym/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at FETCH_HEAD)/src/d3q27_pf_velocity_thermo_planarBenchmark_autosym/Dynamics.R)
...
| Group | Types |
| --- | --- |
|ADDITIONALS|BWall, TWall, Centerline, Smoothing, Spiketrack, Saddletrack, Bubbletrack|
