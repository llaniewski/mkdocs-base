...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d2q9_scmp_Kupershtokh_ViscositySmooth_TRT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d2q9_scmp_Kupershtokh_ViscositySmooth_TRT_HiOrd/Dynamics.R)
