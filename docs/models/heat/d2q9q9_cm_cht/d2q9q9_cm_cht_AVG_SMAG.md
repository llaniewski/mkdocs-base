...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d2q9q9_cm_cht_AVG_SMAG/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d2q9q9_cm_cht_AVG_SMAG/Dynamics.R)
