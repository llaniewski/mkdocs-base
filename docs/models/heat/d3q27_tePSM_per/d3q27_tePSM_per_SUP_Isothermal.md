...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q27_tePSM_per_SUP_Isothermal/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q27_tePSM_per_SUP_Isothermal/Dynamics.R)
