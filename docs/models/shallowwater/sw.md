...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/sw/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/sw/Dynamics.R)
