...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at b778e2d)/src/sw/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at b778e2d)/src/sw/Dynamics.R)
