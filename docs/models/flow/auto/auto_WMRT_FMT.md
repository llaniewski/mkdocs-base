...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/auto_WMRT_FMT/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/auto_WMRT_FMT/Dynamics.R)
