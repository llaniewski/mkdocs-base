...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/auto_part_TRT_FMT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/auto_part_TRT_FMT_HiOrd/Dynamics.R)
