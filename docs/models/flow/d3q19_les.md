...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q19_les/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q19_les/Dynamics.R)
