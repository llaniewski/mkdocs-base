...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q19/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(no branch)/src/d3q19/Dynamics.R)
