...
As per the [FD wave equation tutorial](https://github.com/CFD-GO/TCLB/wiki/Tutorial---FD-Wave-equation), we want to set up a folder named 'my_d2q9_ShanChen' in the _/models/_ folder within TCLB. Additionally, the generic file structure needs to be created consisting of _conf.mk, Dynamics.c, Dynamics.R_. 
