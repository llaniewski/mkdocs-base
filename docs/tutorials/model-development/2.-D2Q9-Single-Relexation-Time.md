...
As in the [previous tutorial](1.-finite-difference-wave-equation), we want to set up a folder named `d2q9srt` in  `~TCLB/models/tutorial/` and create the generic file structure (`conf.mk`, `Dynamics.c`, `Dynamics.R`).
