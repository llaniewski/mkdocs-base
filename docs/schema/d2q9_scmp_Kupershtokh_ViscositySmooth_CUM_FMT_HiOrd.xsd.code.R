...
MODEL="d2q9_scmp_Kupershtokh_ViscositySmooth_CUM_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=TRUE,HiOrd=TRUE)
