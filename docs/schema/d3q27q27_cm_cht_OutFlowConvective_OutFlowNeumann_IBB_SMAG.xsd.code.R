...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann_IBB_SMAG"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=FALSE,IBB=TRUE,SMAG=TRUE,CHT=FALSE)
