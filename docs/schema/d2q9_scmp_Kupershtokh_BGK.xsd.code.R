...
MODEL="d2q9_scmp_Kupershtokh_BGK"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=TRUE,WMRT=FALSE,CUM=FALSE,FMT=FALSE,HiOrd=FALSE)
