...
MODEL="d2q9_scmp_LycettLuo_ViscositySmooth_WMRT_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
