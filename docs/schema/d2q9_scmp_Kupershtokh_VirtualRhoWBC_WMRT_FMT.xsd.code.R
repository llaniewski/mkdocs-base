...
MODEL="d2q9_scmp_Kupershtokh_VirtualRhoWBC_WMRT_FMT"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
