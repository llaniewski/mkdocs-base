...
MODEL="d2q9_scmp_ViscositySmooth_WMRT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
