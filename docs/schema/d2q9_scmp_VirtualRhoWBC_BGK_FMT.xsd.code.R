...
MODEL="d2q9_scmp_VirtualRhoWBC_BGK_FMT"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=FALSE,BGK=TRUE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
