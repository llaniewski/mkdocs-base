...
MODEL="auto_d3q19_part_WMRT_FMT_HiOrd_autosym"
Options=list(d3q19=TRUE,part=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,FMT=TRUE,HiOrd=TRUE,autosym=TRUE)
add.include.dir("tools")
add.include.dir("src")
add.include.dir("models/flow/auto")
setwd("./")
