...
MODEL="d2q9_scmp_LycettLuo_WMRT_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
