...
MODEL="d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_WMRT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
