...
MODEL="d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_WMRT_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=TRUE,HiOrd=TRUE)
add.include.dir("tools")
add.include.dir("src")
add.include.dir("models/multiphase/d2q9_scmp")
setwd("./")
