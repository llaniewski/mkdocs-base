...
MODEL="d3q27_pf_velocity_thermo_planarBenchmark_autosym"
Options=list(OutFlow=FALSE,BGK=FALSE,thermo=TRUE,planarBenchmark=TRUE,autosym=TRUE)
add.include.dir("tools")
add.include.dir("src")
add.include.dir("models/multiphase/d3q27_pf_velocity")
setwd("./")
