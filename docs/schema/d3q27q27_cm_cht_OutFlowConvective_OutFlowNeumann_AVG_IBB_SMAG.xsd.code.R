...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann_AVG_IBB_SMAG"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=TRUE,IBB=TRUE,SMAG=TRUE,CHT=FALSE)
