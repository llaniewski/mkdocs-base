...
MODEL="d2q9_scmp_Kupershtokh_TRT_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=TRUE)
