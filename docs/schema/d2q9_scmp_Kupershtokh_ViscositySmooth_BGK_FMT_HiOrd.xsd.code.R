...
MODEL="d2q9_scmp_Kupershtokh_ViscositySmooth_BGK_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=TRUE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=TRUE)
