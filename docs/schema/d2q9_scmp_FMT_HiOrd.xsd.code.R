...
MODEL="d2q9_scmp_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=TRUE)
