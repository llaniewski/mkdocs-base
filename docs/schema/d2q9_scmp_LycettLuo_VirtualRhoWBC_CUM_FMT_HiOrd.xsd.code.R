...
MODEL="d2q9_scmp_LycettLuo_VirtualRhoWBC_CUM_FMT_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=TRUE,HiOrd=TRUE)
