...
MODEL="d2q9_scmp_VirtualRhoWBC_TRT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
