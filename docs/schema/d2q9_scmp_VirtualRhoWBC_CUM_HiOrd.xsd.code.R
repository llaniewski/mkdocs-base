...
MODEL="d2q9_scmp_VirtualRhoWBC_CUM_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=FALSE,HiOrd=TRUE)
