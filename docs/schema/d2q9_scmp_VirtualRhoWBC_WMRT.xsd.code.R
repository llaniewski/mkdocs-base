...
MODEL="d2q9_scmp_VirtualRhoWBC_WMRT"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=FALSE,HiOrd=FALSE)
