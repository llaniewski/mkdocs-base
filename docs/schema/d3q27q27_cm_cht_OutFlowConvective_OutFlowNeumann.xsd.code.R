...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=FALSE,IBB=FALSE,SMAG=FALSE,CHT=FALSE)
