...
MODEL="d2q9_scmp_Kupershtokh_ViscositySmooth_TRT_FMT"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
