...
MODEL="d2q9_scmp_TRT_FMT"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
