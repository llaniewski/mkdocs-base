...
MODEL="d2q9_scmp_Kupershtokh_VirtualRhoWBC_ViscositySmooth_CUM"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=FALSE,HiOrd=FALSE)
