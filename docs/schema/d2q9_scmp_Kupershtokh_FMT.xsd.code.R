...
MODEL="d2q9_scmp_Kupershtokh_FMT"
Options=list(LycettLuo=FALSE,Kupershtokh=TRUE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
