...
MODEL="d2q9_csf_bcinit_noflow_weno_viscstep_cumulant"
Options=list(bc=FALSE,bcinit=TRUE,noflow=TRUE,weno=TRUE,viscstep=TRUE,cumulant=TRUE)
add.include.dir("tools")
add.include.dir("src")
add.include.dir("models/multiphase/d2q9_csf")
setwd("./")
