...
MODEL="d2q9_scmp_ViscositySmooth_CUM_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=TRUE,HiOrd=TRUE)
