...
MODEL="d2q9_scmp_LycettLuo_CUM"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=FALSE,HiOrd=FALSE)
