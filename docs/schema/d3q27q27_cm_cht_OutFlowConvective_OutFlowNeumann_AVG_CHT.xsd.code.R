...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann_AVG_CHT"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=TRUE,IBB=FALSE,SMAG=FALSE,CHT=TRUE)
