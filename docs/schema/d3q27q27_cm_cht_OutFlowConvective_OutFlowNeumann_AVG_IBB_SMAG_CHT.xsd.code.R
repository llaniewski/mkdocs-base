...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann_AVG_IBB_SMAG_CHT"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=TRUE,IBB=TRUE,SMAG=TRUE,CHT=TRUE)
add.include.dir("tools")
add.include.dir("src")
add.include.dir("models/heat/d3q27q27_cm_cht")
setwd("./")
