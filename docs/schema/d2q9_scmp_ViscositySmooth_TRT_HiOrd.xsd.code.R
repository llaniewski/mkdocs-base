...
MODEL="d2q9_scmp_ViscositySmooth_TRT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
