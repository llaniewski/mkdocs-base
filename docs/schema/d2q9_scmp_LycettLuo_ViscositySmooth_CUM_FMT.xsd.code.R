...
MODEL="d2q9_scmp_LycettLuo_ViscositySmooth_CUM_FMT"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=TRUE,HiOrd=FALSE)
