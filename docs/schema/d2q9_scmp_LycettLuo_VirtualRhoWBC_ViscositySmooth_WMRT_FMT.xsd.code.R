...
MODEL="d2q9_scmp_LycettLuo_VirtualRhoWBC_ViscositySmooth_WMRT_FMT"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=TRUE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
