...
MODEL="d2q9_scmp_VirtualRhoWBC_ViscositySmooth_TRT_FMT_HiOrd"
Options=list(LycettLuo=FALSE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=TRUE)
