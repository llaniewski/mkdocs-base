...
MODEL="d2q9_scmp_LycettLuo_VirtualRhoWBC_ViscositySmooth_TRT_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=TRUE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
