...
MODEL="d2q9_scmp_LycettLuo_FMT"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=FALSE,ViscositySmooth=FALSE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=FALSE,FMT=TRUE,HiOrd=FALSE)
