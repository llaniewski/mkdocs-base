...
MODEL="d3q27q27_cm_cht_OutFlowConvective_OutFlowNeumann_SMAG"
Options=list(OutFlowConvective=TRUE,OutFlowNeumann=TRUE,AVG=FALSE,IBB=FALSE,SMAG=TRUE,CHT=FALSE)
