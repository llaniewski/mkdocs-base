...
MODEL="d2q9_scmp_LycettLuo_VirtualRhoWBC_ViscositySmooth_CUM_FMT_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=FALSE,WMRT=FALSE,CUM=TRUE,FMT=TRUE,HiOrd=TRUE)
