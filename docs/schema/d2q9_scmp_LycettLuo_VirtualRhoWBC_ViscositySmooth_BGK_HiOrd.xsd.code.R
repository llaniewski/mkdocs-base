...
MODEL="d2q9_scmp_LycettLuo_VirtualRhoWBC_ViscositySmooth_BGK_HiOrd"
Options=list(LycettLuo=TRUE,Kupershtokh=FALSE,VirtualRhoWBC=TRUE,ViscositySmooth=TRUE,TRT=FALSE,BGK=TRUE,WMRT=FALSE,CUM=FALSE,FMT=FALSE,HiOrd=TRUE)
